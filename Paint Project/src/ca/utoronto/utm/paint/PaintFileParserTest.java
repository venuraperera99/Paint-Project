...
public class PaintFileParserTest {
	...
	public void parserTest17() throws IOException {
		this.doParserTestCase("samplefiles/squiggle_mult.txt", "Returns true for file with multiple squiggles", "");
	}
	
	@Test
	public void parserTest18() throws IOException {
		this.doParserTestCase("samplefiles/rectangle_wrongend.txt", "Returns false for rect with wrong end"
				, "Error in line 7 ");
	}
	
	@Test
	public void parserTest19() throws IOException {
		this.doParserTestCase("samplefiles/rectangle_fail_values.txt", "Returns false for rect with incorrect values"
				, "Error in line 3 ");
	}
	
	@Test
	public void parserTest20() throws IOException {
		this.doParserTestCase("samplefiles/squiggle_fail_values.txt", "Returns false for squiggle with incorrect values"
				, "Error in line 3 ");
	}
	
	@Test
	public void parserTest21() throws IOException {
		this.doParserTestCase("samplefiles/squiggle_wrongend.txt", "Returns false for squiggle with wrong end"
				, "Error in line 36 ");
	}
	
	@Test
	public void parserTest22() throws IOException {
		this.doParserTestCase("samplefiles/squiggle_wrongorder.txt", "Returns false for squiggle with wrong order"
				, "Error in line 3 ");
	}
	
	@Test
	public void parserTest23() throws IOException {
		this.doParserTestCase("samplefiles/squiggle_wrongpointsend.txt", "Returns false for squiggle with wrong end points"
				, "Error in line 26 ");
	}
	
	@Test
	public void parserTest24() throws IOException {
		this.doParserTestCase("samplefiles/squiggle_nopoints.txt", "Returns true for file with squiggle that has no pints"
				, "");
	}
